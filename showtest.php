...
$role = $_SESSION['sess_userrole'];
	...
	$ques = "select * from students";
	$que = ExecuteQuery($ques);
	$q=mysql_fetch_array($que)
...
$rs=mysql_query("select * from mst_test where sub_id=$subid and course_year='$q[course_year]'");
$numbering="<img src='images/marker1.gif' height='20' width='20'>";
if(mysql_num_rows($rs)<1)
{
	echo "<br><br><p class=fans> No Quiz for this unit </p>";
	exit;
}
echo "<h2 class=style8 align='center'>choose quiz: </h2>";
echo "<table align=center>";

while($row=mysql_fetch_row($rs))
{
	echo "<tr><td>$numbering</td><td align=center  ><b><a href=takequiz.php?testid=$row[0]&subid=$subid><font size=4>$row[2]
	</b></font></a>
	<tr> <td>&nbsp;</td></tr>";
}
echo "</table>";
