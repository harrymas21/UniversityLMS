...
<h2 class="bans"><a href="student_stats.php">
<img src='images/marker1.gif' height='20' width='20'> Click Here to view quiz perfomance history.</a></h2>
<?php
include("database.php");
extract($_SESSION);
$rs=mysql_query("select t.test_name,t.total_que,r.test_date,r.score from mst_test t, mst_result r where
t.test_id=r.test_id and r.login='$_SESSION[uid]'",$cn) or die(mysql_error());

echo "<h1 class=head1> Result </h1>";
if(mysql_num_rows($rs)<1)
{
	echo "<br><br><h1 class=head1> You have not done any quiz</h1>";
	exit;
}
echo "<table border=1 align=center><tr class=style2><td width=300><b>Test Name </b><td><b> Total</b><br><b> Question </b><td><b> Score</b>";
