...
<div class="wrap">
  ...
  <div class="container">
   ...
   <?php
	...
	if ($row["score"] >= 1000)
	{
			echo "<p align='center' style='color:blue' ><strong>CONGRATULATIONS<BR>
			****You have achieved the top-student level with $row[score] points****</strong></p>";
			echo '<table><tr>
			<td>
			<a href="viewleaderboard.php">
			<img src="badges/badge1000.jpg" width="100" height="100">
			<img src="badges/starstudent.jpg" width="100" height="100">
			<img src="badges/topstudent.jpg" width="100" height="100">
			</td>
			<td>
			Total gamification points: '.$row['score'].'<br>
			Total quiz score : '.$row['quiz_score'].'<br>
			Number of badges: 3
			</td>
			</tr>
			</table>';
			}
			elseif($row["score"] >= 500)
			{
			echo "<p align='center' style='color:blue'>
			<strong>****You have achieved the star-student level****<br>
			Achieve more than 1000 points to be a TOP-STUDENT</strong></p>";
				echo '<table><tr>
				<td>
				<a href="viewleaderboard.php">
				<img src="badges/badge500.jpg" width="100" height="100">';
				echo '<img src="badges/starstudent.jpg" width="100" height="100"></a>
				</td>
				<td>Total gamification points: '.$row['score'].'<br>
				Total quiz score : '.$row['quiz_score'].'<br>
				Number of badges: 2
				</td>
				</tr>
				...
				elseif($row["score"] >= 400)
			{
				echo '<table><tr>
				<td>
				<a href="viewleaderboard.php">
				<img src="badges/badge400.jpg" width="100" height="100"></a>
				<td>
				Total gamification points: '.$row['score'].'<br>
				Total quiz score : '.$row['quiz_score'].'<br>
				Number of badges: 1
				...
				elseif($row["score"] >= 200)
			{
				echo '<table><tr>
				<td>
				<a href="viewleaderboard.php">
				<img src="badges/badge200.jpg" width="100" height="100"></a>
				 <td>
				Total gamification points: '.$row['score'].'<br>
				Total quiz score : '.$row['quiz_score'].'<br>
				Number of badges: 1
				...
				elseif($row["score"] >= 150)
			{
				echo '<table><tr>
				<td>
				<a href="viewleaderboard.php">
				<img src="badges/badge150.jpg" width="100" height="100"></a>
				 <td>
				Total gamification points: '.$row['score'].'<br>
				Total quiz score : '.$row['quiz_score'].'<br>
				Number of badges: 1
				...
				elseif($row["score"] >= 100)
			{
				...
				<td>
				<a href="viewleaderboard.php">
				<img src="badges/badge100.jpg" width="100" height="100"></a>
				 <td>
				Total gamification points: '.$row['score'].'<br>
				Total quiz score : '.$row['quiz_score'].'<br>
				Number of badges: 1
				...
				elseif($row["score"] >= 50)
			{
				...
				<td>
				<a href="viewleaderboard.php">
				<img src="badges/badge50.jpg" width="100" height="100"></a>
				 <td>
				Total gamification points: '.$row['score'].'<br>
				Total quiz score : '.$row['quiz_score'].'<br>
				Number of badges: 1
		...
		{
			echo"<hr>";
			echo "<p align='center' style='color:blue'><strong>****Earn some points first to get a badge****<br>
			1. Like questions.<br>
			2. Ask Questions.<br>
			3. Reply to questions.<br>
			4. Message and be active.<br>
			</strong></p>";
			echo"<hr>";
			}
?> 
