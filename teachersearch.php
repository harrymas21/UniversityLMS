...
if (mysql_num_rows($rows) > 0)
{
	...
	while ($row = mysql_fetch_array($rows))
	{
		...
		echo "<td valign='top'><a href=tmessage.php?id=$row[user_id] style='font-weight:bold;'>$row[fullname]</a> <br/>";
		echo ($row['gender'] == 1 ? "Male" : "Female")."<br/>";
		echo $row['country']."<br/>";
		echo $row['role'];
		echo "<br/>";
		echo "<br/>";
		echo "<a href=tmessage.php?id=$row[user_id] style='font-weight:bold;'><input type='button' value='Send Message'></a>";
		echo "</tr>";
	}
