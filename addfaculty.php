...
echo "<br><h2><div  class=bans>Add Faculty: </div></h2>";
if($_POST[submit]=='Add')
{
extract($_POST);
mysql_query("INSERT into faculties(faculty_name,added_by) values 
('$facultyname','$adminid')",$cn) or die(mysql_error());
echo "<p align='center' style='color:red'>Faculty <b>\"$facultyname\"</b> Added Successfully.</p>";
unset($_POST);
}
else
echo"<p align='center' style='color:red'>Sorry! <b>\"$facultyname\"</b> not added... </p>";
?>
<SCRIPT LANGUAGE="JavaScript">
function check() {
fn=document.form1.facultyname.value;
if (fn.length<1) {
...
<form name="form1" method="post" onSubmit="return check();">
  ...
  <table width="75%"  border="0" align="center">   
    <tr>
      ...
      <td>&nbsp;</td>
      <td><input name="facultyname" type="text" id="facultyname" required></td>
    </tr>
    <tr>
      <td height="26"></td>
      <td>&nbsp;</td>
