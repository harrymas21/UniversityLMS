...
<div class="wrap">
  ...
  <div class="container">
    ...
    <p class="bans">TEACHERS: </p>
   <?php
   $result = ExecuteQuery("SELECT * FROM user WHERE role = 'teacher'");
   $no=1;
   echo"<table border=1 align='center'>
   <tr><th>NO.</th><th>NAME</th><th>E-MAIL</th><th></th></tr>";
   while($res=mysql_fetch_array($result)){
	   echo"<tr><td>$no</td><td>$res[fullname]</td><td>$res[e_mail]</td>
	   <td><a href='teacher_handouts.php?id=$res[user_id]'>VIEW HANDOUTS</a></td></tr>";
	   $no++;
	   }
	echo"</table>";
?> 
