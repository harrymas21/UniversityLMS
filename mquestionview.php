...
$str="SELECT * from question, user where  user.user_id=question.user_id AND question_id=$_GET[qid]";
	...
	{	
		while($row = mysql_fetch_array($result))
		{
			...
			echo "<span class='head'><a href='manswer.php?id=$_GET[qid]'>
...
<?php
	...
	{	
		...
		while($row1 = mysql_fetch_array($result))
		{
			...
			<a href='mlike.php?id=$row1[answer_id]&que=$qid' class='view2' ><img src='images/like.png' style='height:30px; width:30px;'/><br>Like[..$row1[like]..]</a>
</span>";
