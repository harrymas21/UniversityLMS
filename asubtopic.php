...
<h2 class="bans"><a href="sinsert.php">click to Insert Subtopic....</a></h2>
	<?php 
		$sql="SELECT subtopic_id, subtopic_name, subtopic_Description, topic.topic_id, topic_name from subtopic, topic where topic.topic_id = subtopic.topic_id";
		$rows=ExecuteQuery($sql);
		
		echo "<table border='1' align='center'>";
		echo "<strong><tr><th>Id</th><th>Subtopic Name</th><th>Subtopic Description</th><th>Topic Name</th><th>Edit</th><th>Delete</th></tr> </strong>";
		
		while($name_row=mysql_fetch_array($rows))
		{
			echo "<tr>";
			echo "<td>$name_row[subtopic_id]</td><td>$name_row[subtopic_name]</td><td>$name_row[subtopic_Description]</td><td>$name_row[topic_name]</td><td><a href='sedit.php?id=".$name_row[0]."'><img src='res/images/edit.jpg' style='height:15px; width:15px;'/></a></td><td><a href='sdelete.php?id=".$name_row[0]."'><img src='res/images/delete.jpg' style='height:15px; width:15px;'/></a></td>";
			}
