...
<div class="wrap">
  ...
  <div class="container">
    ...
    <p class="bans">My materials: </p>
    <?php
	$info=$_GET['info'];
	echo "<p align='center' style='color:red'>$info</p>";
	//echo"<hr/>";
	$username = $_SESSION['sess_username'];
	$sql1="select * from user where username like '$username'";
	$rows1=ExecuteQuery($sql1);
	$row1 = mysql_fetch_array($rows1);
	$uid=$row1['user_id'];
	
$sql="SELECT * FROM material_uploads WHERE added_by LIKE '$uid'";
...
if (mysql_num_rows($rows) > 0)
{
	...
	while ($row = mysql_fetch_array($rows))
	{
		...
		echo $row['views'];
		echo "<br/>";
		echo"<a href='handoutdelete.php?id=".$row[0]."'><img src='res/images/delete.jpg' style='height:15px; width:15px;'/>
		<strong>DELETE HANDOUT</strong></a>";
		echo "<hr/>";
		echo "</tr>";
	}
