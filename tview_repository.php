...
<div class="wrap">
  ...
  <div class="container">
   ...
   while ($row = mysql_fetch_array($rows))
	{
		$sql2 = "SELECT * FROM user WHERE user_id = $row[added_by]";
		 $rows2=ExecuteQuery($sql2);
		 $row2 = mysql_fetch_array($rows2);
		 echo"<tr><td>
		 <a href='http://$row[file]' download='filename'>
		 $num. Document: $row[document_name]</a><br>
		 Description: $row[description]<br>
		 Uploaded by : $row2[fullname] *$row2[role]*<br>
		 Uploaded on: $row[timestamp]
		 </td>
		 <td>
		 <a href='tupvote.php?id=$row[rep_id]'>
		 <img src='images/uplike.png' height='40' width='40' alt='UP-VOTE'></a> $row[upvote]
		 <a href='tdownvote.php?id=$row[rep_id]'>
		  <img src='images/downlike.jpg' height='35' width='35' alt='DOWN-VOTE'></a> $row[downvote]<br>
		 </td>
		 </tr>";
		 $num++;
		 		}
