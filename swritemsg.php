...
<div class="wrap">
  ...
  <div class="container">
    <aside>
      <h2>Categories:</h2>
      <ul class="categories">
        <li><span><a href="#">HANDOUTS</a></span></li>
        ...
        <li><span><a href="#">CHALLENGE</a></span></li>
...
$game="UPDATE students SET score = score+3 WHERE user_id ='$_SESSION[sess_username]'";
$result=ExecuteNonQuery($sql);
if ($result)
$result2=ExecuteNonQuery($game);
	header("location:sreadmsg.php?id=$chid");
?>
